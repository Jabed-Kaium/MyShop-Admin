...
public class changeMyshopUserPassword extends javax.swing.JFrame {

    /**
     * Creates new form changeMyshopUserPassword
     */
    public changeMyshopUserPassword() {
        initComponents();
    }
    ...
    private void buttonConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConfirmActionPerformed
        ...
        try{
            ...
            if(p.equals(oldPass) && newPass.equals(confirmPass)){
                st.executeUpdate("update userPass set password = '"+newPass+"'");
    ...
    private void buttonMinimizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMinimizeActionPerformed
        this.setExtendedState(changeMyshopUserPassword.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(changeMyshopUserPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
